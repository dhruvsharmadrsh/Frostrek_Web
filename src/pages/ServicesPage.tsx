...
import { Users, Brain, Code, Bot, Smartphone, Workflow, CheckCircle } from 'lucide-react';
                ...
                <div className="container mx-auto px-4 md:px-6 relative z-10">
                    ...
                    >
                        <h1 className="text-4xl md:text-5xl lg:text-6xl font-bold text-gray-900 mb-6">
                            Customized <span className="text-teal-600">Solutions</span>
                        </h1>
            ...
            <section className="py-16 relative">
                <div className="container mx-auto px-4 md:px-6">
                    ...
                    >
                        ...
                        <p className="text-xl text-gray-600">We are committed to:</p>
                    </motion.div>
                    ...
                    <div className="grid grid-cols-1 md:grid-cols-3 gap-8 max-w-4xl mx-auto">
                        {coreValues.map((value, index) => (
                            <motion.div
                                ...
                                className="bg-white/80 backdrop-blur-md border-2 border-teal-500/50 rounded-xl p-8 text-center hover:border-teal-600 hover:shadow-lg transition-all duration-300"
                            >
                        ...
                        {services.map((service, index) => {
                            ...
                            return (
                                <motion.div
                                    ...
                                    viewport={{ once: true }}
                                    transition={{ duration: 0.6, delay: index * 0.1 }}
                                    className="group relative bg-white/80 backdrop-blur-md border-2 border-teal-500/50 rounded-xl p-6 hover:border-teal-600 hover:shadow-xl transition-all duration-300"
                                >
                                    <div className="absolute inset-0 bg-gradient-to-br from-teal-500/10 to-transparent opacity-0 group-hover:opacity-100 transition-opacity duration-300 rounded-xl" />

                                    <div className="relative">
                                        <div className="flex items-start justify-between mb-4">
                                            <span className="text-5xl font-bold text-teal-500/30">{service.number}</span>
                    ...
                    <div className="grid grid-cols-2 md:grid-cols-3 lg:grid-cols-6 gap-4 max-w-5xl mx-auto">
                        {customSolutions.map((solution, index) => (
                            <motion.div
                                ...
                                className="bg-gradient-to-br from-teal-500/20 to-teal-700/10 border border-teal-500/50 rounded-lg p-4 text-center hover:border-teal-600 hover:shadow-lg hover:shadow-teal-500/20 transition-all duration-300"
                            >
                                <p className="text-gray-900 font-semibold text-sm">{solution}</p>
                            </motion.div>
                        ))}
                    </div>
                </div>
                    ...
                    <div className="grid grid-cols-1 lg:grid-cols-2 gap-12 items-center">
                        ...
                        >
                            ...
                            <div className="flex gap-4">
                                ...
                                <div>
                                    <h4 className="text-gray-900 font-semibold mb-2">AI Talent Sourcing</h4>
                                    <p className="text-gray-600 text-sm">Access to top-tier AI professionals ready to integrate into your team</p>
                                </div>
                            </div>
                        </motion.div>
                        ...
                        >
                            <div className="w-full h-80 bg-gradient-to-br from-teal-100/50 to-teal-200/30 rounded-xl border border-teal-300 flex items-center justify-center">
                                <Users className="w-32 h-32 text-teal-600/70" />
                            </div>
                        </motion.div>
                    </div>
                </div>
            ...
            <section className="py-20 relative">
                <div className="container mx-auto px-4 md:px-6">
                    <div className="grid grid-cols-1 lg:grid-cols-2 gap-12 items-center">
                        ...
                        >
                            <div className="w-full h-80 bg-gradient-to-br from-teal-100/50 to-teal-200/30 rounded-xl border border-teal-300 flex items-center justify-center">
                                <Brain className="w-32 h-32 text-teal-600/70" />
                            </div>
                        </motion.div>
                        ...
                        >
                            ...
                            <div className="bg-teal-500/10 border border-teal-500/30 rounded-lg p-4">
                                <p className="text-teal-700 font-semibold text-lg">5000+ Training Sessions Conducted</p>
                            </div>
                        </motion.div>
                    </div>
                </div>
            ...
            <section className="py-20 relative">
                <div className="container mx-auto px-4 md:px-6">
                    <div className="grid grid-cols-1 lg:grid-cols-2 gap-12 items-center">
                        ...
                        >
                            <div className="w-full h-80 bg-gradient-to-br from-teal-100/50 to-teal-200/30 rounded-xl border border-teal-300 flex items-center justify-center">
                                <Code className="w-32 h-32 text-teal-600/70" />
                            </div>
                        </motion.div>
                    </div>
                </div>
            ...
            <section className="py-20 relative">
                <div className="container mx-auto px-4 md:px-6">
                    <motion.div
                        ...
                        viewport={{ once: true }}
                        transition={{ duration: 0.6 }}
                        className="bg-gradient-to-br from-teal-500/20 to-teal-700/10 border-2 border-teal-500/50 rounded-2xl p-12 text-center"
                    >
                        <h2 className="text-3xl md:text-4xl font-bold text-gray-900 mb-4">
                        ...
                        <button className="px-8 py-4 bg-teal-600 hover:bg-teal-700 text-white font-semibold rounded-lg transition-all duration-300 shadow-lg shadow-teal-600/30 hover:shadow-teal-700/40">
