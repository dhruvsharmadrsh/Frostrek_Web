...
const Footer = () => {
    ...
    return (
        ...
        .section-title::after {
          ...
          left: 0;
          height: 2px;
          background: rgba(22, 119, 125, 0.5);
          width: 0;
        }
        ...
        .iso-badge:hover {
          ...
          box-shadow: 0 0 12px rgba(22, 119, 125, 0.3);
        }
        ...
        .email-shimmer::after {
          ...
          width: 100%;
          height: 100%;
          background: linear-gradient(90deg, transparent, rgba(22, 119, 125, 0.2), transparent);
          pointer-events: none;
        }
      ...
      `}</style>
                            ...
                            <div className="flex items-center gap-6">
                                <div className="flex-shrink-0">
                                    <svg className="careers-icon w-16 h-16 opacity-80" viewBox="0 0 64 64" fill="none">
                                        <circle cx="32" cy="32" r="28" stroke="currentColor" strokeWidth="2" className="text-teal-600" />
                                        <circle cx="32" cy="16" r="4" fill="currentColor" className="text-teal-700 network-node" />
                                        <circle cx="16" cy="32" r="4" fill="currentColor" className="text-teal-700 network-node" />
                                        <circle cx="48" cy="32" r="4" fill="currentColor" className="text-teal-700 network-node" />
                                        <circle cx="32" cy="48" r="4" fill="currentColor" className="text-teal-700 network-node" />
                                        <line x1="32" y1="20" x2="32" y2="28" stroke="currentColor" strokeWidth="2" className="text-teal-600" />
                                        <line x1="20" y1="32" x2="28" y2="32" stroke="currentColor" strokeWidth="2" className="text-teal-600" />
                                        <line x1="36" y1="32" x2="44" y2="32" stroke="currentColor" strokeWidth="2" className="text-teal-600" />
                                        <line x1="32" y1="36" x2="32" y2="44" stroke="currentColor" strokeWidth="2" className="text-teal-600" />
                                    </svg>
                                </div>
                ...
                <div className="container mx-auto px-4 md:px-6">
                    <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-5 gap-12 mb-16">
                        ...
                        <div className="lg:col-span-2 space-y-6">
                            ...
                            <div className="flex flex-wrap gap-3 pt-4">
                                <div className="iso-badge px-3 py-1.5 bg-teal-50 border border-teal-200 rounded-full text-xs font-semibold text-teal-800 cursor-pointer">
                            ...
                            <div className="space-y-3 pt-4">
                                ...
                                >
                                    ...
                                    {locationWidgetOpen && (
                                        <div className="location-widget absolute left-0 bottom-full mb-3 w-64 bg-gray-800 rounded-xl shadow-lg overflow-hidden z-30">
                                            {/* Static Map Preview */}
                                            <div className="relative h-32 bg-gradient-to-br from-teal-700 to-teal-900 overflow-hidden">
                                            ...
                                            <div className="p-4 space-y-2">
                                                ...
                                                <div className="text-teal-300 text-sm">Serving clients globally</div>
                                ...
                                <div className="flex items-center gap-3 text-gray-600 email-container">
                                    ...
                                    <button
                                        onClick={copyEmail}
                                        className="email-shimmer hover:text-teal-700 transition-colors flex items-center gap-2 group"
                                    >
                                        <span>{COMPANY_INFO.contact}</span>
                                        {emailCopied ? (
                                            <Check size={14} className="text-teal-700 copy-notification" />
                                        ) : (
                                ...
                                {emailCopied && (
                                    <div className="text-xs text-teal-700 font-medium copy-notification">
                            ...
                            <div className="relative pt-2" ref={langRef}>
                                <button
                                    ...
                                    className="lang-switcher flex items-center gap-2 px-4 py-2 border-2 border-gray-300 rounded-lg hover:border-teal-600 text-sm font-medium"
                                >
                                    ...
                                    <div className="lang-dropdown absolute bottom-full mb-2 left-0 bg-white border-2 border-gray-200 rounded-lg shadow-lg overflow-hidden z-10">
                                        {LANGUAGES.map(lang => (
                                            ...
                                            >
                                                ...
                                                {selectedLang === lang.code && <Check size={16} className="text-teal-700" />}
                                            </button>
                                        ))}
                                    </div>
                                )}
                        ...
                        <div className="space-y-4">
                            ...
                            <ul className="space-y-2">
                                {NAV_ITEMS.find(n => n.label === 'Products')?.megaMenu?.flatMap(s => s.items).slice(0, 5).map(item => (
                                    <li key={item.name}>
                                        <a href={item.href} className="footer-link text-gray-600 hover:text-teal-700 text-sm">
                                            {item.name}
                                        </a>
                                    </li>
                                ))}
                        ...
                        <div className="space-y-4">
                            ...
                            <ul className="space-y-2">
                                <li><a href="/about" className="footer-link text-gray-600 hover:text-teal-700 text-sm">About Us</a></li>
                                <li><a href="/services" className="footer-link text-gray-600 hover:text-teal-700 text-sm">Services</a></li>
                                <li><a href="/resources" className="footer-link text-gray-600 hover:text-teal-700 text-sm">Resources</a></li>
                                <li><a href="/careers" className="footer-link text-gray-600 hover:text-teal-700 text-sm">Careers</a></li>
                                <li><a href="/contact" className="footer-link text-gray-600 hover:text-teal-700 text-sm">Contact</a></li>
                            </ul>
                        </div>
                    </div>
                    ...
                    <div className="border-t border-gray-200 pt-8 flex flex-col md:flex-row items-center justify-between gap-4">
                        ...
                        <div className="flex items-center gap-4">
                            <a href={COMPANY_INFO.socials.linkedin} className="social-icon w-10 h-10 rounded-full bg-teal-50 flex items-center justify-center text-teal-700 hover:bg-teal-700 hover:text-white">
                                <Linkedin size={18} />
                            </a>
                            <a href={COMPANY_INFO.socials.twitter} className="social-icon w-10 h-10 rounded-full bg-teal-50 flex items-center justify-center text-teal-700 hover:bg-teal-700 hover:text-white">
                                <Twitter size={18} />
                            </a>
                            <a href={COMPANY_INFO.socials.facebook} className="social-icon w-10 h-10 rounded-full bg-teal-50 flex items-center justify-center text-teal-700 hover:bg-teal-700 hover:text-white">
                                <Facebook size={18} />
                            </a>
                        </div>
                    </div>
            ...
            <div className="fixed right-0 top-1/2 -translate-y-1/2 z-50">
                <button
                    ...
                    className="feedback-tab bg-teal-700 text-white px-3 py-6 rounded-l-lg font-semibold text-sm shadow-lg hover:bg-teal-800"
                            ...
                            <div className="space-y-4">
                                <div>
                                    ...
                                    <select
                                        ...
                                        className="w-full px-3 py-2 border-2 border-gray-300 rounded-lg focus:border-teal-600 focus:outline-none transition-colors"
                                    >
                                        <option>Bug</option>
                                ...
                                <div>
                                    ...
                                    <textarea
                                        ...
                                        className="w-full px-3 py-2 border-2 border-gray-300 rounded-lg focus:border-teal-600 focus:outline-none resize-none transition-colors"
                                    />
                                </div>
                                ...
                                <button
                                    ...
                                    className="w-full bg-teal-700 text-white py-3 rounded-lg font-semibold hover:bg-teal-800 transition-colors disabled:opacity-50 disabled:cursor-not-allowed"
                                >
                                    Submit Feedback
                                </button>
                            </div>
            ...
            {showBackToTop && (
                <button
                    onClick={scrollToTop}
                    className="back-to-top fixed bottom-8 right-8 w-12 h-12 bg-teal-700 text-white rounded-full shadow-lg hover:bg-teal-800 flex items-center justify-center z-40 transition-colors"
